...
abstract class $SectionCopyWith<$Res> {
  ...
  @useResult
  $Res call({String? id, String nom, String? specialite});
}
...
class _$_Section implements _Section {
  const _$_Section({this.id, required this.nom, this.specialite});
  ...
  @override
  String toString() {
    return 'Section(id: $id, nom: $nom, specialite: $specialite)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, nom, specialite);
...
abstract class _Section implements Section {
  const factory _Section(
      ...
      final String? specialite}) = _$_Section;
